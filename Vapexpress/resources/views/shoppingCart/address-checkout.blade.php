                ...
                <form method="POST" action="{{ route('cart.address') }}">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input id="full_name" name="full_name" placeholder="" type="text" required
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input id="contact_phone" name="contact_phone" placeholder="" type="text" required
                                class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 
                                focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input id="direction" name="direction" placeholder="" type="text" required
                                class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 
                                focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <input id="city" name="city" type="text" required placeholder=""
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <input id="province" name="province" type="text" required placeholder=""
                                class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md 
                                placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 
                                transition duration-150 ease-in-out sm:text-sm sm:leading-5
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <input id="zip_code" name="zip_code" type="text" required placeholder=""
                                class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md 
                                placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 
                                transition duration-150 ease-in-out sm:text-sm sm:leading-5
