@switch(true)
    @case(session('success'))
        <div class="alert bg-green-100 border-l-4 border-green-500 text-green-700 p-4 rounded-md shadow-md flex items-center space-x-3"
            role="alert">
    ...
    @case(session('error'))
        <div class="alert bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded-md shadow-md flex items-center space-x-3"
            role="alert">
