...
@section('content')
    <div class="pt-4 pb-12 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
        <div class="flex justify-start item-start space-y-2 flex-col">
            <h1 class="text-3xl lg:text-4xl font-semibold leading-7 lg:leading-9 text-navbar">
                Pedido #{{ $order->id }}
            </h1>
        ...
        <div class="mt-10 flex flex-col xl:flex-row justify-center items-stretch w-full xl:space-x-8">
                        ...
                        <div
                            ...
                            <div class="pb-4 md:pb-8 w-full md:w-40">
                                <img class="w-full hidden md:block"
                                    src="{{ asset('img/productos/' . $product->url_image) }}" alt="{{ $product->name }}">
                            </div>
                            <div
                                class="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full pb-8 space-y-4 md:space-y-0">
                                <div class="w-full flex flex-col justify-start items-start space-y-8">
                                    <h3 class="text-xl xl:text-2xl font-semibold leading-6 text-navbar">
                                        {{ $product->name }}
                                    </h3>
            ...
            <div class="flex flex-col w-full xl:w-1/3 space-y-4 md:space-y-6 xl:space-y-8">
                <!-- Resumen -->
                <div class="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 space-y-6">
                    <h3 class="text-xl font-semibold leading-5 text-navbar">
                        Resumen
                    </h3>
                ...
                <div class="flex flex-col justify-center px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 space-y-6">
                    <h3 class="text-xl font-semibold leading-5 text-navbar">Estado del pedido</h3>
                    <div class="flex justify-between items-start w-full">
                        <div class="flex justify-center items-center space-x-4">
                            ...
                            <div class="flex flex-col justify-start items-center">
                                <p class="text-lg leading-6 font-semibold text-navbar">
                                    UPS
                                    <br />
                                    <span class="font-normal">Envío rápido y seguro 24/48h</span>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="w-full grid gap-8 grid-cols-2">
                        ...
                        <a href="{{ $order->tracking_url }}" target="_blank" class="no-underline">
                            <button
                                class="hover:bg-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 py-2 w-54 md:w-full bg-navbar text-base font-medium leading-2 text-white rounded-lg">
                                Localizar Pedido
                            </button>
                        </a>
                    </div>
